...
const PROJECTS: AppEntry[] = [
  ...
  },
  {
    ...
    color: "linear-gradient(135deg, #FF9500 0%, #E65100 100%)",
    preview: "img/previews/share.png"
  },
  {
    id: "anime-wallpapers",
    name: "Anime Wallpapers",
    subtitle: "Discover Live Wallpapers",
    category: "Graphics & Design",
    icon: "img/icons/photos.png",
    description: "Browse, search, and set high-res Pixabay anime wallpapers directly as your desktop background.",
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: "14px", flex: 1 }}>Lalit Kumar</span>
        </button>
      </div>
