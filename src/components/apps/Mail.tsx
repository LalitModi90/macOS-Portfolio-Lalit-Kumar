...
export default function Mail() {
  ...
  return (
    <div className="flex h-full w-full bg-[#f5f5f7] dark:bg-[#14171f] text-gray-900 dark:text-gray-100 rounded-b-xl overflow-hidden select-none relative">
      ...
      <div className="w-40 sm:w-44 flex-shrink-0 bg-[#ebebf0]/95 dark:bg-[#181a22]/95 border-r border-black/10 dark:border-white/10 flex flex-col py-2 backdrop-blur-xl">
      ...
      <div className="w-64 sm:w-72 flex-shrink-0 bg-[#f8f8fc]/95 dark:bg-[#161821]/95 border-r border-black/10 dark:border-white/10 flex flex-col overflow-hidden">
        {/* Search */}
      ...
      <AnimatePresence>
        {composing && (
          <motion.div
            ...
            className="absolute bottom-4 right-4 w-full max-w-lg bg-white/95 dark:bg-[#1a1c24]/95 backdrop-blur-2xl rounded-2xl shadow-2xl border border-black/10 dark:border-white/15 flex flex-col overflow-hidden z-50"
          >
            {/* Modal Header */}
            ...
            <form onSubmit={handleSendEmail} className="flex flex-col">
              ...
              <textarea
                ...
                rows={7}
                className="p-4 bg-transparent border-none outline-none text-xs sm:text-sm text-gray-800 dark:text-gray-100 placeholder-gray-400 resize-none leading-relaxed"
              />
