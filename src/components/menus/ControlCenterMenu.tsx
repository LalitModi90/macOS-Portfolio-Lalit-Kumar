...
const WifiSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
...
const BluetoothSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polyline points="6.5 6.5 17.5 17.5 12 23 12 1 17.5 6.5 6.5 17.5" />
  </svg>
);

const AirDropSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2L6 8h4v6h4V8h4l-6-6z" />
    <path d="M4 14v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4" />
  </svg>
);

const MoonSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
  </svg>
);

const SunSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const KeyboardSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
...
const ArrowsInSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const ArrowsOutSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const GridSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const ScreenMirroringSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect x="2" y="3" width="20" height="14" rx="2" />
    <polygon points="12 17 6 22 18 22" fill="currentColor" />
  </svg>
);

const SpeakerSVG = ({ size = 16, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const PlaySVG = ({ size = 18, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <polygon points="5 3 19 12 5 21 5 3" />
  </svg>
);

const PauseSVG = ({ size = 18, className = "text-current" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
        ...
        {isMobile ? (
          ...
          <>
            ...
            <div className="cc-grid col-span-2 p-2.5 flex flex-col justify-around space-y-2">
              ...
              <div className="hstack space-x-2.5 cursor-pointer" onClick={toggleDark}>
                <div className={`${dark ? "cc-btn" : "cc-btn-active"}`}>
                  {dark ? <MoonSVG size={16} /> : <SunSVG size={16} />}
                </div>
            ...
            <div className="cc-grid flex-center flex-col cursor-pointer py-2" onClick={() => toggleFullScreen(!fullscreen)}>
              {fullscreen ? <ArrowsInSVG size={16} /> : <ArrowsOutSVG size={16} />}
            ...
            <div className="cc-grid col-span-4 px-2.5 py-2 space-y-1 flex flex-col justify-around">
              ...
              <SliderComponent icon={<SunSVG size={14} className="text-gray-500" />} value={brightness} setValue={setBrightness} />
            </div>

            <div className="cc-grid col-span-4 px-2.5 py-2 space-y-1 flex flex-col justify-around">
              <span className="font-medium ml-0.5" style={{ fontSize: '12px' }}>Sound</span>
              <SliderComponent icon={<SpeakerSVG size={14} className="text-gray-500" />} value={volume} setValue={setVolume} />
            </div>
            ...
            <div className="player cc-grid col-span-4 hstack space-x-2.5" p="y-2 l-2 r-4">
              ...
              {playing ? (
                <div className="cursor-pointer" onClick={() => toggleAudio(false)}>
                  <PauseSVG size={22} />
                </div>
              ) : (
                <div className="cursor-pointer" onClick={() => toggleAudio(true)}>
                  <PlaySVG size={22} />
                </div>
              )}
            </div>
