...
declare global {
  ...
  const AnimeWallpapers: typeof import('./components/apps/AnimeWallpapers')['default']
  ...
  const DEFAULT_MAP_CENTER: typeof import('./components/maps/mapConfig')['DEFAULT_MAP_CENTER']
  const DEFAULT_MAP_ZOOM: typeof import('./components/maps/mapConfig')['DEFAULT_MAP_ZOOM']
  ...
  const MapControls: typeof import('./components/maps/MapControls')['default']
  const MapView: typeof import('./components/maps/MapView')['default']
  ...
  const SiriVoiceAssistant: typeof import('./components/SiriVoiceAssistant')['default']
  ...
  const TILE_PROVIDERS: typeof import('./components/maps/mapConfig')['TILE_PROVIDERS']
  ...
  const calculateDistance: typeof import('./components/maps/mapUtils')['calculateDistance']
  const clockTsxTmp44631: typeof import('./components/apps/Clock.tsx.tmp.44631.35136336935d')['default']
  const createCustomMarkerIcon: typeof import('./components/maps/mapUtils')['createCustomMarkerIcon']
  ...
  const formatDistance: typeof import('./components/maps/mapUtils')['formatDistance']
  const forwardRef: typeof import('react')['forwardRef']
  const getSvgIconMarkup: typeof import('./components/maps/mapUtils')['getSvgIconMarkup']
  ...
  const searchLocation: typeof import('./components/maps/mapUtils')['searchLocation']
  ...
  const useSiriAssistant: typeof import('./hooks/useSiriAssistant')['useSiriAssistant']
