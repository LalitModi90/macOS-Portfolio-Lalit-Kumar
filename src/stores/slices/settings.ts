...
export const wallpaperSets: WallpaperSet[] = [
  ...
  },
  {
    id: "tahoe-light",
    name: "Tahoe Graphic",
    day: "/img/ui/tahoe-day.png",
    night: "/img/ui/tahoe-night.png",
    thumbnail: "/img/ui/tahoe-day.png",
  },
  {
    id: "tahoe-beach",
    name: "Tahoe Space",
...
export const createSettingsSlice: StateCreator<SettingsSlice> = (set, get) => ({
  ...
  customWallpaper: loadSetting<string | null>("customWallpaper", null),
  setActiveWallpaperSet: (id) => {
    saveSetting("activeWallpaperSet", id);
    saveSetting("wallpaperId", id);
    saveSetting("customWallpaper", null);
    set({ activeWallpaperSet: id, wallpaperId: id, customWallpaper: null });
  },
  setWallpaper: (url: string) => {
    saveSetting("customWallpaper", url);
  ...
  setWallpaperId: (id) => {
    ...
    saveSetting("activeWallpaperSet", id);
    saveSetting("customWallpaper", null);
    set({ wallpaperId: id, activeWallpaperSet: id, customWallpaper: null });
  },
  getWallpaper: () => {
    const custom = get().customWallpaper;
    if (custom) {
      return {
        id: "custom",
